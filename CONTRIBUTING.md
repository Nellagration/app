[![Nellagration Open Source Codebase](./public/social_preview_index.jpg)](https://bolt.new)

> Welcome to the **Nellagration** open-source codebase! This repo contains a simple example app using the core components from bolt.new to help you get started building **AI-powered software development tools** powered by StackBlitz’s **WebContainer API**.

### Why Build with Nellagration + WebContainer API
...
### What’s the Difference Between Nellagration (This Repo) and [Bolt.new](https://bolt.new)?
...
Nellagration is built with [Remix](https://remix.run/) and
deployed using [CloudFlare Pages](https://pages.cloudflare.com/) and
[CloudFlare Workers](https://workers.cloudflare.com/).

### AI SDK Integration

Nellagration uses the [AI SDK](https://github.com/vercel/ai) to integrate with AI
